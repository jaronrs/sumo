...
public:
    ...
    const std::map<const SUMOVehicle*, const ApproachingVehicleInformation, ComparatorIdLess>& getApproaching() const {
...
private:
    ...
    std::map<const SUMOVehicle*, const ApproachingVehicleInformation, ComparatorIdLess> myApproachingVehicles;
