...
public class TraCILogic {
  ...
  public TraCILogic(String _subID, int _type, int _currentPhaseIndex, TraCIPhaseVector _phases) {
    this(libsumoJNI.new_TraCILogic__SWIG_1(_subID, _type, _currentPhaseIndex, TraCIPhaseVector.getCPtr(_phases), _phases), true);
  }

  public TraCILogic(String _subID, int _type, int _currentPhaseIndex) {
    this(libsumoJNI.new_TraCILogic__SWIG_2(_subID, _type, _currentPhaseIndex), true);
  }

  public void setSubID(String value) {
    libsumoJNI.TraCILogic_subID_set(swigCPtr, this, value);
  }

  public String getSubID() {
    return libsumoJNI.TraCILogic_subID_get(swigCPtr, this);
  }
