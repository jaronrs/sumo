...
public class TrafficLight {
  ...
  public static SWIGTYPE_p_std__vectorT_libsumo__TraCILogic_t getCompleteRedYellowGreenDefinition(String tlsID) {
    return new SWIGTYPE_p_std__vectorT_libsumo__TraCILogic_t(libsumoJNI.TrafficLight_getCompleteRedYellowGreenDefinition(tlsID), true);
  }
